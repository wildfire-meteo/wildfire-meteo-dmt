...
// counting up regardless: it is the stable key the editor and the plot select on. A new
// parcel starts from `source` when given, so a sensitivity run varies one knob from it.
export function make_parcel(existing, source = null)
{
